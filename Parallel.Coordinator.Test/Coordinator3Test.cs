...
{
    [TestFixture]
    public class Coordinator3Test : CoordinatorMultiTest
    {
        ...
        public void ParallelSuccessful()
        {
            ...
            var coord = Coordinator3.Do(instructions[0], instructions[1], instructions[2], _argument);
                                                        ...
                                                        ManualResetEventSlim[] notifyEvents, CancellationToken cancellationToken, Exception argument)
        {
            Task t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    //this should throw
                    Coordinator3.Do(cancellationToken, instructions[0], instructions[1], instructions[2], argument);
                }
                finally
                {
