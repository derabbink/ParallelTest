...
{
    [TestFixture]
    public class Coordinator6Test : CoordinatorMultiTest
    {
        ...
        public void ParallelSuccessful()
        {
            ...
            var coord = Coordinator6.Do(instructions[0], instructions[1], instructions[2], instructions[3], instructions[4], instructions[5], _argument);
                                                        ...
                                                        ManualResetEventSlim[] notifyEvents, CancellationToken cancellationToken, Exception argument)
        {
            Task t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    //this should throw
                    Coordinator6.Do(cancellationToken, instructions[0], instructions[1], instructions[2], instructions[3], instructions[4], instructions[5], argument);
                }
                finally
                {
