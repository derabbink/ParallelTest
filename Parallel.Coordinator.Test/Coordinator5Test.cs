...
{
    [TestFixture]
    public class Coordinator5Test : CoordinatorMultiTest
    {
        ...
        public void ParallelSuccessful()
        {
            ...
            var coord = Coordinator5.Do(instructions[0], instructions[1], instructions[2], instructions[3], instructions[4], _argument);
                                                        ...
                                                        ManualResetEventSlim[] notifyEvents, CancellationToken cancellationToken, Exception argument)
        {
            Task t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    //this should throw
                    Coordinator5.Do(cancellationToken, instructions[0], instructions[1], instructions[2], instructions[3], instructions[4], argument);
                }
                finally
                {
