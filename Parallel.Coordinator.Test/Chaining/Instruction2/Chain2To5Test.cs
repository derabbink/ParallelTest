...
{
    [TestFixture]
    public class Chain2To5Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperations()
        {
            ...
            var coordinator = Coordinator2.Do(_1_1Instr, _1_1Instr, _argument1)
                .ThenDo(_2_2Instr, _2_2Instr, _2_2Instr, _2_2Instr, _2_2Instr);
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_2_2Instr, _2_2Instr, _2_2Instr, _2_2Instr, _throw2_2Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Coordinator2.Do(cts.Token, _1_1Instr, _1_1Instr, _argument1).ThenDo(_2_2Instr, _2_2Instr, _2_2Instr, _2_2Instr, _blocking2_2Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Coordinator2.Do(cts.Token, _1_1Instr, _1_1Instr, _argument1).ThenDo(_2_2Instr, _2_2Instr, _2_2Instr, _2_2Instr, _timeoutable2_2Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
