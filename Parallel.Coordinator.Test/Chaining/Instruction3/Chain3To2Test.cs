...
{
    [TestFixture]
    public class Chain3To2Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_3_3Instr, _throw3_3Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Coordinator3.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_3_3Instr, _blocking3_3Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Coordinator3.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_3_3Instr, _timeoutable3_3Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
