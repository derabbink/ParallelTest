...
{
    [TestFixture]
    public class Chain1To2Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_1_1Instr, _throw1_1Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Interface.Coordinator.Do(cts.Token, _1_1Instr, _argument1).ThenDo(_1_1Instr, _blocking1_1Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Interface.Coordinator.Do(cts.Token, _1_1Instr, _argument1).ThenDo(_1_1Instr, _timeoutable1_1Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
