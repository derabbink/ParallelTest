...
{
    [TestFixture]
    public class Chain1To1Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_throw1_1Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Interface.Coordinator.Do(cts.Token, _1_1Instr, _argument1).ThenDo(_blocking1_1Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Interface.Coordinator.Do(cts.Token, _1_1Instr, _argument1).ThenDo(_timeoutable1_1Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
