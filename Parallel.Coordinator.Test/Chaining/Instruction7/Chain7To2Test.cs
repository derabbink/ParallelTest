...
{
    [TestFixture]
    public class Chain7To2Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_7_7Instr, _throw7_7Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Coordinator7.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_7_7Instr, _blocking7_7Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Coordinator7.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_7_7Instr, _timeoutable7_7Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
