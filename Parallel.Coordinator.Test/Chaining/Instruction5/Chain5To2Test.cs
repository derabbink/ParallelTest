...
{
    [TestFixture]
    public class Chain5To2Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_5_5Instr, _throw5_5Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Coordinator5.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_5_5Instr, _blocking5_5Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Coordinator5.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_5_5Instr, _timeoutable5_5Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
