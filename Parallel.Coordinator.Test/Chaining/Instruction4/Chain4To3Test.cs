...
{
    [TestFixture]
    public class Chain4To3Test : ChainingTest
    {
        #region tests
        ...
        public void Do2ChainedOperations()
        {
            ...
            var coordinator = Coordinator4.Do(_1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1)
                .ThenDo(_4_4Instr, _4_4Instr, _4_4Instr);
        ...
        public void Do2ChainedOperationsError()
        {
            ...
            try
            {
                coordinator.ThenDo(_4_4Instr, _4_4Instr, _throw4_4Instr);
            }
        ...
        public void Cancellation2ChainedWorks()
        {
            ...
            {
                Coordinator4.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_4_4Instr, _4_4Instr, _blocking4_4Instr);
            });
            _notify.Wait();
            cts.Cancel();
            try
        ...
        public void Timeout2ChainedWorks()
        {
            ...
            Task t = Task.Factory.StartNew(() =>
            {
                Coordinator4.Do(cts.Token, _1_1Instr, _1_1Instr, _1_1Instr, _1_1Instr, _argument1).ThenDo(_4_4Instr, _4_4Instr, _timeoutable4_4Instr);
            });
            _notify.Wait();
            //cts.Cancel();
            try
