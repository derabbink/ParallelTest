...
namespace Parallel.Worker.Interface
{
    ...
    {
        public static Task<SafeInstructionResult<TResult>> Execute<TArgument, TResult>(this IExecutor executor, Func<TArgument, TResult> instruction, TArgument argument, IServer<TArgument, TResult> invocationChannel, IClient<TResult> callbackChannel)
