...
namespace Parallel.Worker.Interface
{
    ...
    {
        public static Future<SafeInstructionResult<TResult>> Execute<TArgument, TResult>(this IExecutor executor, Action<TArgument, Action<TResult>> instruction, TArgument argument)
