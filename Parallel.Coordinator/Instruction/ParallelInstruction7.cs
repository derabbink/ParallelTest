...
{
    public class ParallelInstruction<TArgument, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7> :
        LocalInstruction<TArgument, Tuple<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>>
        ...
        where TResult7 : class
    {
        public ParallelInstruction(CoordinatedInstruction<TArgument, TResult1> instruction1,
            ...
            : base(
                ComposeDelegate(instruction1, instruction2, instruction3, instruction4, instruction5, instruction6, instruction7),
                instruction1.Timeout == -1 || instruction2.Timeout == -1 || instruction3.Timeout == -1 || instruction4.Timeout == -1 || instruction5.Timeout == -1 || instruction6.Timeout == -1 || instruction7.Timeout == -1
                    ? -1
                    : Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(Math.Max(instruction1.Timeout, instruction2.Timeout), instruction3.Timeout), instruction4.Timeout), instruction5.Timeout), instruction6.Timeout), instruction7.Timeout))
        {}
        ...
        public ParallelInstruction(CoordinatedInstruction<TArgument, TResult1> instruction1,
                                   ...
                                   CoordinatedInstruction<TArgument, TResult7> instruction7,
                                   int timeoutMS)
            : base(ComposeDelegate(instruction1, instruction2, instruction3, instruction4, instruction5, instruction6, instruction7), timeoutMS)
        { }

        private static Func<CancellationToken, Action, TArgument, Tuple<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>>
                            ...
                            CoordinatedInstruction<TArgument, TResult7> instruction7)
        {
            ...
            Func<CancellationToken, Action, TArgument, Tuple<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>> result = (ct, progress, arg) =>
                {
                    ...
                    CancellationTokenSource[] ctss = ParallelInstruction.GenerateCancellationTokenSources(7);
                    ...
                    return new Tuple<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>(future1.Result, future2.Result, future3.Result, future4.Result, future5.Result, future6.Result, future7.Result);
                };
            return result;
        }
    }
